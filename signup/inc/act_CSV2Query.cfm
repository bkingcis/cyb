<cffile action = "read"  
		file = "#ExpandPath( '/userFiles/' & newFile )#"  
		variable = "csvString">
		
		<cfset arr = csvToArray( csv = csvString ) />
		<cfdump var="#arr#"><cfabort>
<!--- <cftry>
	
	<cfset objSheet.Query = csvToQuery(csvString)>
	<cfcatch>
		<cfdump var="#csvstring#">
		<cfdump var="#cfcatch#">
		<cfabort>
	</cfcatch>
</cftry> --->
