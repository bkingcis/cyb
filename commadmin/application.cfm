...
<cfif NOT isDefined("application.appInitialized") OR NOT application.appInitialized>
	<cfscript>
		...
		application.galleryObj = createObject( 'component', 'admin.model.gallery' );
		application.downloadObj = createObject( 'component', 'admin.model.download' );
		...
		application.staffObj = createObject( 'component', 'admin.model.staff' );
...
<cfscript>
	...
	galleryObj = application.galleryObj;
	downloadObj = application.downloadObj;
