...
<html>
<head>
	<title>Cybatrol - Administration Area</title>
	<link href="css/styles.css" type="text/css" rel="stylesheet"> 
	<script type="text/javascript" src="js/tabcontent.js"></script>
	<script type="text/javascript" src="js/tabcontentsave.js"></script> 
	<SCRIPT SRC="/qforms.js"></SCRIPT>
	<SCRIPT LANGUAGE="JavaScript">
	qFormAPI.setLibraryPath("/qforms/lib/");
	qFormAPI.include("*");	
	// adjust error background color
	qFormAPI.errorColor = "#ccccff";
	</SCRIPT>
	<!-- These control the asynchronous ajax calls -->	
	<script type="text/javascript" src="http://www.udr.com/resources/js/yui/build/yahoo-min.combined.js"></script>
