...
<div style="clear:both;"></div><br /><br />
	...
	<cfif form.allSelected IS  "">
		<div align="center">
		<strong>You must chose at least one date to successfully schedule #label.permanent_visitor#.</strong><br>		
		<form><br />		
	...
	<cfif ListLen(form.allSelected) gt 1>
		<div align="center">
		<strong>Please choose only one Initial Visit Date for #labels.permanent_visitor# #labels.visitor#s.</strong><br>		
		<form><br />		
		<input type="button" onClick="history.back();" value=" Go Back "  style="color: red;">
		</form>
		</div>
